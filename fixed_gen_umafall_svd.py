...
for path, dirs, files in os.walk(dir_path):
    ...
    for file in files:
        ...
        # Khởi tạo công cụ chuẩn hóa và Truncated SVD
        ...
        for j in range(5):
            ...
            # Kiểm tra kích thước sau khi áp dụng Truncated SVD
            ...
            X_transformed = svd.fit_transform(scaled).reshape((window_size,))
